...
class LoginView extends React.Component {
  ...
  createLoginView() {
    return (<div>
            ...
            <RaisedButton
              primary style={styles.margin} label="Увайсці"
              onClick={() => this.enter()}
            />
            <RaisedButton secondary style={styles.margin} label="Забыўся пароль"
  ...
  createRemindView() {
    return (<div>
            ...
            <RaisedButton
              primary style={styles.margin} label="Узгадаў :)"
              onClick={() => this.setState({ remindMode: false })}
            />
            <RaisedButton secondary style={styles.margin} label="Адправіць"
              onClick={() => this.remind()}
            />
        </div>);
  }
